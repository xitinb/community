...
CREATE TABLE `t_friend`  (
  `id` bigint(20) NOT NULL AUTO_INCREMENT,
  `blog_address` varchar(255) CHARACTER SET utf8 COLLATE utf8_general_ci NOT NULL,
  `blog_name` varchar(255) CHARACTER SET utf8 COLLATE utf8_general_ci NOT NULL,
  `create_time` datetime(0) NULL DEFAULT NULL,
...
-- Records of t_user
-- ----------------------------
INSERT INTO `t_user` VALUES (1, 'seer', '12345', '1', '2021-04-08 20:38:13', '2367394188@qq.com', 'seerLiang', NULL, NULL, 'user:testindex');
